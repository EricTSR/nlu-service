...
Reusable technology-specific guidance is available under `.agents/skills/`.

Before implementing or modifying code:

1. Inspect `.agents/skills/` for skills relevant to the task.
2. Read the relevant `SKILL.md` files before making implementation decisions.
3. Apply those skills together with the repository-specific rules in this file.
4. Do not load or apply unrelated skills.
...
2. Repository-specific rules in `AGENTS.md`
3. Relevant `.agents/skills/*/SKILL.md` guidance
4. Existing project conventions

Agent Skills provide reusable technology and library-specific knowledge.
`AGENTS.md` defines the architecture, conventions, and constraints specific to this repository.
